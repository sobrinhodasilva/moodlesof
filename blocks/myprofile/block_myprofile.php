...
class block_myprofile extends block_base {
    ...
    public function get_content() {
		...
		/**********************************************************************************************/
		/* Inserir link (SAIR) no Bloco perfil do Usuario                                             */
		/* @Autor: Wesley Gongora de Almeida (#WGA)                                                   */
		/* @Data: 24/05/2013                                                                          */
		/**********************************************************************************************/
		$this->content->text .= '<div class="logout"><a href="' . $CFG->wwwroot . '/login/logout.php">(Sair)</a></div>';
		/**********************************************************************************************/
