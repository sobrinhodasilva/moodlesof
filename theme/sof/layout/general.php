...
<div id="page">
	...
	<div id="wrapper">
		...
		<div id="barra-brasil">
			<div class="barra">
				<ul>
					<li><a href="http://www.acessoainformacao.gov.br" target="_blank" class="ai" title="Acesso à informação">www.sic.gov.br</a></li>
			...
			<div id="cabecalho-conteudo">			
				<div id="cabecalho-conteudo-esq">
					...
					<div class="cabecalho-conteudo-esq-logo">
						<a title="Clique para ir para a p&aacute;gina inicial da Escola Virtual SOF" href="<?php p($CFG->wwwroot); ?>">
							<?php if ($haslogo) {
	...
	<!-- end OF moodle CONTENT wrapper -->
		...
		<div id="page-footer">	
			...
			<?php
			//echo $OUTPUT->login_info();
			//customizaçao do rodapé do moodle2
